# Astro_SaaS
Astro_SaaS is a modular FastAPI-based SaaS platform for astrology and numerology analysis, featuring layered architecture, reusable analysis engines, and scalable API-driven design aimed at building an AI-ready report generation system.
...
User inputs are processed through modular analysis engines

Insights are generated using rule-based and extensible logic
...
Service Layer – Orchestrates business logic and engine execution

Analysis Engines – Independent modules for numerology, timeline, and report logic
